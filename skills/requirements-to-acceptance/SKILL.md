...
5. Name the verification steps before implementation begins.

Ask a concise question only when a missing answer would make a reasonable implementation risky. Otherwise, state the assumption and continue.
