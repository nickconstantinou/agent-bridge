...
export function openDb(dbPath: string): BridgeDb {
  ...
  raw.exec(`
    ...
    CREATE TABLE IF NOT EXISTS work_jobs (
      ...
      task_type        TEXT NOT NULL CHECK (task_type IN ('defect_scan','feature_research','implementation_plan','run_tdd_fix','open_github_issue','open_pull_request','verify_pull_request','ops_check','tdd_implementation')),
