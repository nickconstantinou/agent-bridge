...
_write_shared_defaults() {
  local dest="${DEFAULTS_DIR}/agent-bridge-shared"
  {
    ...
    echo "BRIDGE_ADVISOR_ENABLED=${BRIDGE_ADVISOR_ENABLED:-true}"
    echo "BRIDGE_ADVISOR_MODE=${BRIDGE_ADVISOR_MODE:-manual}"
    echo "BRIDGE_ADVISOR_CHAIN=${BRIDGE_ADVISOR_CHAIN:-claude:claude-fable-5,codex:gpt-5.6-sol}"
    echo "BRIDGE_ADVISOR_MAX_CALLS_PER_TURN=${BRIDGE_ADVISOR_MAX_CALLS_PER_TURN:-1}"
    echo "BRIDGE_ADVISOR_MAX_CALLS_PER_TASK=${BRIDGE_ADVISOR_MAX_CALLS_PER_TASK:-2}"
    echo "BRIDGE_ADVISOR_TIMEOUT_MS=${BRIDGE_ADVISOR_TIMEOUT_MS:-120000}"
    echo "BRIDGE_ADVISOR_CONTEXT_MAX_CHARS=${BRIDGE_ADVISOR_CONTEXT_MAX_CHARS:-24000}"
