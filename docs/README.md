...
Do not move or archive a document until `docs/DOCUMENTATION-AUDIT.md` classifies it and confirms whether code, tests, `AGENTS.md`, README, systemd, worker prompts, or operator flows still reference it.